...
public class UCExcluirAtendenteComExito {
  ...
  @Test
  public void testUCExcluirAtendenteComExito() throws Exception {
    ...
    try {
      assertEquals("× Atendente excluida com sucesso!", driver.findElement(By.cssSelector("div.alert.alert-warning")).getText());
    } catch (Error e) {
