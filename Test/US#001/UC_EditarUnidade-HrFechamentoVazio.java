...
public class UCEditarUnidadeHrFechamentoVazio {
  ...
  @Test
  public void testUCEditarUnidadeHrFechamentoVazio() throws Exception {
    ...
    driver.findElement(By.id("horaFechamento")).sendKeys("");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    try {
      assertEquals("Este campo não pode ser vazio", driver.findElement(By.id("horaFechamento-error")).getText());
    } catch (Error e) {
