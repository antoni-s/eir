...
public class UCEditarUnidadeBairroVazio {
  ...
  @Test
  public void testUCEditarUnidadeBairroVazio() throws Exception {
    driver.get(baseUrl + "/");
    ...
    try {
      assertEquals("Este campo não pode ser vazio", driver.findElement(By.id("bairro-error")).getText());
    } catch (Error e) {
