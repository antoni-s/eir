...
public class UCEditarUnidadeHrAberturaVazio {
  ...
  @Test
  public void testUCEditarUnidadeHrAberturaVazio() throws Exception {
    ...
    driver.findElement(By.id("horaAbertura")).sendKeys("");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    try {
      assertEquals("Este campo não pode ser vazio", driver.findElement(By.id("horaAbertura-error")).getText());
    } catch (Error e) {
