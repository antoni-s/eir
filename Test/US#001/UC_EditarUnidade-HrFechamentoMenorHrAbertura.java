...
public class UCEditarUnidadeHrFechamentoMenorHrAbertura {
  ...
  @Test
  public void testUCEditarUnidadeHrFechamentoMenorHrAbertura() throws Exception {
    ...
    driver.findElement(By.id("horaAbertura")).sendKeys("9");
    driver.findElement(By.id("horaFechamento")).clear();
    driver.findElement(By.id("horaFechamento")).sendKeys("6");
    try {
