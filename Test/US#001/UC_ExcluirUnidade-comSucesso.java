...
public class UCExcluirUnidadeComSucesso {
  ...
  @Test
  public void testUCExcluirUnidadeComSucesso() throws Exception {
    ...
    try {
      assertEquals("× Unidade excluida com sucesso!", driver.findElement(By.cssSelector("div.alert.alert-warning")).getText());
    } catch (Error e) {
