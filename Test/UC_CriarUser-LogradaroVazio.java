...
public class UC_CriarUser-LogradaroVazio {
	...
	@Test
	public void testUC_CriarUser-LogradaroVazio() throws Exception {
		selenium.open("/");
		...
		assertEquals("Este campo não pode ser vazio", selenium.getText("id=logradouro-error"));
	}
