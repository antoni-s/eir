<div class="container">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form action="http://<?php echo APP_HOST; ?>/atendente/salvar" method="post" id="form_cadastro_atendente">
                <div class="form-group">
                    <label for="nome">Nome</label>
                    <input type="text" class="form-control"  name="nome" placeholder="Nome do Atendente" value="<?php echo $Sessao::retornaValorFormulario('nome'); ?>" required>

                </div>
                <div class="form-group">
                    <label for="cpf">CPF</label>
                    <input type="text" class="form-control" name="cpf" placeholder="CPF do Atendente" value="<?php echo $Sessao::retornaValorFormulario('cpf'); ?>" maxlength="11" required>

                </div>
                <div class="form-group">
                    <label for="matricula">Matricula</label>
                    <input type="text" class="form-control" name="matricula" placeholder="Matricula do Atendente" value="<?php echo $Sessao::retornaValorFormulario('matricula'); ?>" maxlength="13" required>
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="email" placeholder="Email do Atendente" value="<?php echo $Sessao::retornaValorFormulario('email'); ?>" required>

                </div>
                <div class="form-group">
                    <label for="logradouro">Logradouro</label>
                    <input type="text" class="form-control" name="logradouro" placeholder="Rua/Avenida do Atendente" value="<?php echo $Sessao::retornaValorFormulario('logradouro'); ?>" required>

                </div>
                <div class="form-group">
                    <label for="bairro">Bairro</label>
                    <input type="text" class="form-control" name="bairro" placeholder="Bairro/Setor do Atendente" value="<?php echo $Sessao::retornaValorFormulario('bairro'); ?>" required>

                </div>
                <div class="form-group">
                    <label for="complemento">Complemento</label>
                    <input type="text" class="form-control" name="complemento" placeholder="Quadra/Lote/Número do Atendente" value="<?php echo $Sessao::retornaValorFormulario('complemento'); ?>" required>

                </div>
                <div class="form-group">
                    <label for="cep">CEP</label>
                    <input type="text" class="form-control" name="cep" placeholder="CEP do Atendente" value="<?php echo $Sessao::retornaValorFormulario('cep'); ?>" maxlength="8" required>
                ...
                <a href="http://<?php echo APP_HOST; ?>/atendente" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> Voltar</a>
            </form>
        </div>
        <div class=" col-md-3"></div>
    </div>
